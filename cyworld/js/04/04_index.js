const menuHome = () => {
    document.getElementById("contentFrame").setAttribute("src","04_home.html")
...
const menuJukebox = () => {
    document.getElementById("contentFrame").setAttribute("src","04_jukebox.html")
...
const menuGame = () => {
    document.getElementById("contentFrame").setAttribute("src","04_game.html")
